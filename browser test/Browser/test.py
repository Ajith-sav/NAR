...
class MainWindow(QMainWindow):
 ...
 #-------------------------------------------------------------------       
        ...
        newTabAction.triggered.connect(lambda: self.add_new_tab(QUrl('https://6izzvuoxeyunx5ezlxvvfg.on.drv.tw/www.startup_page,com/home.html'), "New tab"))
        ...
        # creating first tab
        self.add_new_tab(QUrl('https://6izzvuoxeyunx5ezlxvvfg.on.drv.tw/www.startup_page,com/home.html'), 'Homepage')
    ...
    def readSettings(self):
        setting = QSettings()
        self.defaultUrl = setting.value("defaultUrl", QUrl('https://6izzvuoxeyunx5ezlxvvfg.on.drv.tw/www.startup_page,com/home.html'))
    ...
    def add_new_tab(self, qurl=None, label="New tab"):
        ...
        if qurl is None:
            ...
            qurl = QUrl('https://6izzvuoxeyunx5ezlxvvfg.on.drv.tw/www.startup_page,com/home.html')
    ...
    def navigate_home(self):
        ...
        # go to dockdockgo
        self.tabs.currentWidget().setUrl(QUrl("https://6izzvuoxeyunx5ezlxvvfg.on.drv.tw/www.startup_page,com/home.html"))
